...
export interface ApiAlbumAlbum extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    artists: Schema.Attribute.Relation<'manyToOne', 'api::artist.artist'>;
    albumfoto: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
...
export interface ApiSongSong extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    lyrics3: Schema.Attribute.Blocks;
    artists: Schema.Attribute.Relation<'oneToMany', 'api::artist.artist'>;
